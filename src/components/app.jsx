...
class App extends Component {
        ...
        state={
            ...
            Footer:{
                footerdata:[
                    'We\'re Hiring!',
                    'hello@digitalcrafts.com' ,
                    '(833) 327 - 2387',
                ],
                f1:[
                    
                    '© 2018 DigitalCrafts, LLC ',
                    'State Catalogues: GA | TX ',
                    'Privacy and Complaint Policy',
                ],
                f2:[

                    'Student Blog on Medium' ,
    ...
    render(){
        ...
        return (
        <div>
            <Home foter={this.state.Footer} achiv={this.state.Achivment} ourcontent={this.state.ourData} main={this.state.Main} pro={this.state.Process} event={this.state.Events} course={this.state.Course} tabs={this.state.Tabs} review={this.state.Review} involved={this.state.Involved} aim={this.state.Aim} team={this.state.Team} teacher={this.state.TeacherR} service={this.state.Service}/>
        </div>
        );
    }
}
